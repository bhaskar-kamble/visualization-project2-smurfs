...
```{r}
get_relative_frequencies_interactive(DL_MFH, 'Procentual consumption per fuel by bundesland')
```
...
get_co2_emissions_interactive(mfh_area, DL_MFH, co2_coef, 'Co2 Emissions by Bundesland')
```
