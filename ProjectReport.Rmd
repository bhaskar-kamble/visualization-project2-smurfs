...
for (s in names(bundlands_SV_mfh)) {
  bundSV_mfh_df[[s]] <- c(bundlands_SV_mfh[[s]]$spz_verbrauch, rep(2,1))
...
p <- plot_ly(bundlands_energietraeger , x = seq(2002, 2018, by = 1), type = 'bar') %>%
  add_markers(y = ~bundlands_energietraeger[bundlands_energietraeger$bundesland == states[3],]$erdgas, name = " ",marker=list(color="black")) %>%
    add_trace(y = ~bundlands_energietraeger[bundlands_energietraeger$bundesland == states[3],]$fluessiggas, name = 'LA Zoo') %>%
  add_markers(y = ~bundlands_energietraeger[bundlands_energietraeger$bundesland == states[2],]$erdgas, name = " ",marker=list(color="black")) %>%
    add_trace(y = ~bundlands_energietraeger[bundlands_energietraeger$bundesland == states[2],]$fluessiggas, name = 'LA Zoo') %>%
  layout(
