...
Thus we see that there are `r nrow(DL_MFH)` observations for multifamily houses. The `ènergietraeger` is the source of fuel used for heating the building. The other variables of interest are the year of construction `gebaeude_baujahr`, the year in which the energy was measured (`abrechnungsjahr`), and the area of the building (`genaeude_nutzflaeche`).
...
## 5d. Specific Energy Consumption for Multi and 1-2 Family Houses combined for the federal states
