...
```{r,fig.cap="\\label{fig:figs}Fig. 5: Interactive plot for the specific energy consumption for the 16 federal states from 2002-2018."}
p
```


```{r,fig.cap="\\label{fig:figs}Fig. 6: Heat map of the specific energy consumption for the year and the state"}
library(plotly)
...
# 8.a SOM interpretations of SFH
```{r}
library(plotly)
library(tidyr)
plot_som(DL_SFH)
