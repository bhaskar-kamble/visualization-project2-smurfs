...
library(rdwd)
link <- selectDWD("Saarland", res="daily", var="kl", per="recent")
file <- dataDWD(link, read=FALSE, dir="DWDdata", quiet=TRUE, force=NA)
selectDWD("Potsdam", res="annual", var="kl", per="rh")
clim <- readDWD(file, varnames=TRUE)

data(metaIndex)
str(metaIndex, vec.len=2)
metaIndex$Bundesland
metaIndex[metaIndex$Bundesland == "Baden-Wuerttemberg" & metaIndex$per == "historical",]
```
