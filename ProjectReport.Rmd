...
```{r,fig.cap="\\label{fig:figs}Fig. 19: Interactive plot for the specific energy consumption for the 16 federal states for both (MFH+SFH combined) type of buildings from 2002-2018."}
